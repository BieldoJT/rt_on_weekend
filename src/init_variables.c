...
/*   Updated: 2025/07/18 17:58:58 by natrodri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	create_world(t_rt *rt)
{
	...
	rt->world[rt->world_size++] = sphere_create(vec3(0.0, 2.0, 2.0), 0.5,
			diffuse_light_create(vec3(50, 50, 50)));
}
